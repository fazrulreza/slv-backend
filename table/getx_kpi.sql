CREATE TABLE `getx_kpi` (
	...
	INDEX `FK_getx_kpi_company_profile` (`COMPANY_ID`) USING BTREE,
	CONSTRAINT `FK_getx_kpi_company_profile` FOREIGN KEY (`COMPANY_ID`) REFERENCES `slv`.`company_profile` (`ID`) ON UPDATE NO ACTION ON DELETE NO ACTION
)
