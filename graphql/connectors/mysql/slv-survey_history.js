...
const { mysqlConnection, SURVEY_HISTORY } = require('../../../config');
...
const MysqlSlvSurveyHistory = new MysqlModel(connection, SURVEY_HISTORY, attributes);

module.exports = MysqlSlvSurveyHistory;
