...
const { mysqlConnection, ASSESSMENT } = require('../../../config');
...
const MysqlSlvAssessment = new MysqlModel(connection, ASSESSMENT, attributes);

module.exports = MysqlSlvAssessment;
